      ...
      <main>
          ...
          <div className="relative z-10 text-center px-4 max-w-4xl pt-20">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-8">
              <button 
                ...
                className="w-full sm:w-auto bg-primary text-on-primary px-12 py-4 text-[10px] font-black tracking-[0.2em] uppercase hover:scale-105 transition-all duration-300"
              >
                GET FULL ACCESS
              </button>
            </div>
        ...
        <section className="relative py-32 overflow-hidden bg-background">
          ...
          <div className="relative z-10 px-4 text-center">
            ...
            <button 
              onClick={handleNavToForm}
              className="group relative px-12 py-6 bg-white text-black text-[11px] font-black tracking-[0.4em] uppercase overflow-hidden hover:text-white transition-colors duration-500"
            >
